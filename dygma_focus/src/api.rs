...
impl Focus {
    ...
    fn command_response_string(&mut self, command: &str) -> anyhow::Result<String> {
    ...
    fn command_response_numerical<T>(&mut self, command: &str) -> anyhow::Result<T>
    where
        T: FromStr,
    ...
    fn command_response_bool(&mut self, command: &str) -> anyhow::Result<bool> {
        let response = self.command_response_string(command)?;
        Ok(response == "1")
    }

    /// Sends a command to the device, and returns the response as a vector of strings.
    fn command_response_vec_string(&mut self, command: &str) -> anyhow::Result<Vec<String>> {
        Ok(self
...
impl Focus {
    ...
    pub fn version_get(&mut self) -> anyhow::Result<String> {
    ...
    pub fn keymap_custom_get(&mut self) -> anyhow::Result<String> {
    ...
    pub fn keymap_custom_set(&mut self, data: &str) -> anyhow::Result<()> {
    ...
    pub fn keymap_default_get(&mut self) -> anyhow::Result<String> {
    ...
    pub fn keymap_default_set(&mut self, data: &str) -> anyhow::Result<()> {
    ...
    pub fn keymap_only_custom_get(&mut self) -> anyhow::Result<bool> {
    ...
    pub fn keymap_only_custom_set(&mut self, state: bool) -> anyhow::Result<()> {
    ...
    pub fn settings_default_layer_get(&mut self) -> anyhow::Result<i8> {
    ...
    pub fn settings_default_layer_set(&mut self, layer: i8) -> anyhow::Result<()> {
    ...
    pub fn settings_valid_get(&mut self) -> anyhow::Result<bool> {
    ...
    pub fn settings_version_get(&mut self) -> anyhow::Result<String> {
    ...
    pub fn settings_version_set(&mut self, version: &str) -> anyhow::Result<()> {
    ...
    pub fn settings_crc_get(&mut self) -> anyhow::Result<String> {
    ...
    pub fn eeprom_contents_get(&mut self) -> anyhow::Result<String> {
    ...
    pub fn eeprom_contents_set(&mut self, data: &str) -> anyhow::Result<()> {
    ...
    pub fn eeprom_free_get(&mut self) -> anyhow::Result<String> {
    ...
    pub fn super_keys_map_get(&mut self) -> anyhow::Result<String> {
    ...
    pub fn super_keys_map_set(&mut self, data: &str) -> anyhow::Result<()> {
        if data.len() > 1_024 {
    ...
    pub fn super_keys_wait_for_get(&mut self) -> anyhow::Result<u16> {
        self.command_response_numerical("superkeys.waitfor")
    }

    /// Sets the wait for value in milliseconds of the keyboard to alter the behaviour of the super keys. Wait for value specifies the time between the first and subsequent releases of the HOLD actions meanwhile is held, so for example, if the variable is set to 500ms, you can maintain the hold key, it will emmit a key code corresponding to the action that it triggers, then it will wait for wait for time for making another key press with that same key code. This enables the user to delay the hold "machinegun" to be able to release the key and achieve a single keypress from a hold action. https://github.com/Dygmalab/Bazecor/blob/development/FOCUS_API.md#superkeyswaitfor
    pub fn super_keys_wait_for_set(&mut self, milliseconds: &str) -> anyhow::Result<()> {
    ...
    pub fn super_keys_timeout_get(&mut self) -> anyhow::Result<u16> {
    ...
    pub fn super_keys_timeout_set(&mut self, milliseconds: u16) -> anyhow::Result<()> {
    ...
    pub fn super_keys_repeat_get(&mut self) -> anyhow::Result<u16> {
        self.command_response_numerical("superkeys.repeat")
    }

    /// Sets the repeat value of the keyboard to alter the behaviour of the super keys. The repeat value specifies the time between the second and subsequent key code releases when on hold, it only takes effect after the wait for timer has been exceeded. https://github.com/Dygmalab/Bazecor/blob/development/FOCUS_API.md#superkeysrepeat
    pub fn super_keys_repeat_set(&mut self, milliseconds: u16) -> anyhow::Result<()> {
    ...
    pub fn super_keys_hold_start_get(&mut self) -> anyhow::Result<u16> {
        self.command_response_numerical("superkeys.holdstart")
    }

    /// Sets the hold start value of the keyboard to alter the behaviour of the super keys. The hold start value specifies the minimum time that has to pass between the first key down and any other action to trigger a hold, if held it will emit a hold action. https://github.com/Dygmalab/Bazecor/blob/development/FOCUS_API.md#superkeysholdstart
    pub fn super_keys_hold_start_set(&mut self, milliseconds: u16) -> anyhow::Result<()> {
    ...
    pub fn super_keys_overlap_get(&mut self) -> anyhow::Result<u8> {
        self.command_response_numerical("superkeys.overlap")
    }

    /// Sets the overlap percentage of the keyboard to alter the behaviour of the super keys. The overlap value specifies the percentage of overlap when fast typing that is allowed to happen before triggering a hold action to the overlapped key pressed after the super key. https://github.com/Dygmalab/Bazecor/blob/development/FOCUS_API.md#superkeysoverlap
    pub fn super_keys_overlap_set(&mut self, percentage: u8) -> anyhow::Result<()> {
        if percentage > 80 {
    ...
    pub fn led_at_get(&mut self, led: u16) -> anyhow::Result<Color> {
    ...
    pub fn led_at_set(&mut self, led: u8, color: Color) -> anyhow::Result<()> {
        self.command(&format!(
            "led.at {} {} {} {}",
    ...
    pub fn led_all_set(&mut self, color: Color) -> anyhow::Result<()> {
    ...
    pub fn led_mode_get(&mut self) -> anyhow::Result<LedMode> {
    ...
    pub fn led_mode_set(&mut self, mode: LedMode) -> anyhow::Result<()> {
    ...
    pub fn led_brightness_get(&mut self) -> anyhow::Result<u8> {
    ...
    pub fn led_brightness_set(&mut self, brightness: u8) -> anyhow::Result<()> {
    ...
    pub fn led_brightness_underglow_get(&mut self) -> anyhow::Result<u8> {
    ...
    pub fn led_brightness_underglow_set(&mut self, brightness: u8) -> anyhow::Result<()> {
    ...
    pub fn led_brightness_wireless_get(&mut self) -> anyhow::Result<u8> {
    ...
    pub fn led_brightness_wireless_set(&mut self, brightness: u8) -> anyhow::Result<()> {
    ...
    pub fn led_brightness_underglow_wireless_get(&mut self) -> anyhow::Result<u8> {
    ...
    pub fn led_brightness_underglow_wireless_set(&mut self, brightness: u8) -> anyhow::Result<()> {
        self.command(&format!("led.brightnessUG.wireless {}", brightness))
    }

    /// Gets the LED fade. Undocumented.
    pub fn led_fade_get(&mut self) -> anyhow::Result<u16> {
        self.command_response_numerical("led.fade")
    }

    /// Sets the LED fade. Undocumented.
    pub fn led_fade_set(&mut self, fade: u16) -> anyhow::Result<()> {
    ...
    pub fn led_theme_get(&mut self) -> anyhow::Result<String> {
    ...
    pub fn led_theme_set(&mut self, data: &str) -> anyhow::Result<()> {
    ...
    pub fn palette_get(&mut self) -> anyhow::Result<String> {
    ...
    pub fn palette_set(&mut self, data: &str) -> anyhow::Result<()> {
    ...
    pub fn color_map_get(&mut self) -> anyhow::Result<String> {
    ...
    pub fn led_idle_time_limit_get(&mut self) -> anyhow::Result<u16> {
    ...
    pub fn led_idle_time_limit_set(&mut self, seconds: u16) -> anyhow::Result<()> {
        if seconds > 65_000 {
            bail!("Seconds must be 65000 or below: {}", seconds);
        }
    ...
    pub fn led_idle_wireless_get(&mut self) -> anyhow::Result<bool> {
        self.command_response_bool("idleleds.wireless")
    }

    /// Sets the idle LED wireless state.
    pub fn led_idle_wireless_set(&mut self, state: bool) -> anyhow::Result<()> {
    ...
    pub fn hardware_version_get(&mut self) -> anyhow::Result<String> {
    ...
    pub fn macros_map_get(&mut self) -> anyhow::Result<String> {
    ...
    pub fn macros_map_set(&mut self, data: &str) -> anyhow::Result<()> {
        if data.len() > 2_048 {
            bail!("Data must be 1024 bytes or less: {}", data.len());
        }
    ...
    pub fn macros_trigger(&mut self, macro_id: u8) -> anyhow::Result<()> {
        self.command(&format!("macros.trigger {}", macro_id))
    }

    /// Gets the macros memory size in bytes.
    pub fn macros_memory_get(&mut self) -> anyhow::Result<u16> {
    ...
    pub fn layer_activate(&mut self, layer: u8) -> anyhow::Result<()> {
    ...
    pub fn layer_deactivate(&mut self) -> anyhow::Result<()> {
    ...
    pub fn layer_is_active_get(&mut self) -> anyhow::Result<u8> {
    ...
    pub fn layer_move_to(&mut self, layer: u8) -> anyhow::Result<()> {
    ...
    pub fn layer_state_get(&mut self) -> anyhow::Result<Vec<bool>> {
    ...
    pub fn wireless_rf_channel_hop_get(&mut self) -> anyhow::Result<bool> {
        self.command_response_bool("wireless.rf.channelHop")
    }

    /// Sets the RF channel hop state. Undocumented.
    pub fn wireless_rf_channel_hop_set(&mut self, state: bool) -> anyhow::Result<()> {
        self.command(&format!("wireless.rf.channelHop {}", state as u8))
    }

    /// Gets the sync pairing state. Undocumented.
    pub fn wireless_rf_sync_pairing_get(&mut self) -> anyhow::Result<bool> {
